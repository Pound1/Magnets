...
//    override the colour of the [phone time, carrier/wifi signal & battery life] symbols
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if #available(iOS 13.0, *) {
            ...
            // With iOS 13, a new navigation appearance API was
            // introduced. The code below ensures the same iOS 12
            // navigation appearance is maintained.
